...
$select_products = $conn->prepare("SELECT product_name product_name , price price , amount amount from main_products m INNER JOIN products p on m.id=p.main_product_id;");
...
<body>
    ...
    <script type="module">
        ...
        const productMaterial2 = new THREE.MeshBasicMaterial({
            color: 0xffff00
        });
            ...
            for (let i = 0; i < 3; i++) {
                for (let j = 0; j < 3; j++) {
                    ...
                    loader.load('https://threejs.org/examples/fonts/helvetiker_regular.typeface.json', function(font) {
                        ...
                        const text1Mesh = new THREE.Mesh(textGeometryName, new THREE.MeshBasicMaterial({
                            color: 0x333333
                        }));
                        const text2Mesh = new THREE.Mesh(textGeometryPrice, new THREE.MeshBasicMaterial({
                            color: 0x777777
                        }));
                        const text3Mesh = new THREE.Mesh(textGeometryamount, new THREE.MeshBasicMaterial({
                            color: 0x999999
                        }));
                        ...
                        scene.add(text1Mesh, text2Mesh, text3Mesh);
                    });
                }
